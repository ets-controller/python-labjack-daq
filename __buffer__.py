...
# Output to autovalve
def autovalve():
    return DATA, LOG, buffName, analysis['overFill'], analysis['ident'], results['ident'], avgTime
        ...
        while True:
            ...
            if n == N[-1]:
                ...
                if len(N) > buffSpace:
                    ...
                    f.close()
                    N = N[1:]
                    # This line will run the example feedback control script if autoStatus was set to True
